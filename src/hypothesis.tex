...
\begin{example}
    Suppose that $X_1, X_2, \ldots, X_n$ is a random sample from a $N(\mu, \sigma^2)$ population, 
...
\begin{solution}
    ...
    \[
        {\color{gray!45!white} \lgblksquare} \quad \Omega = \{ (\mu, \sigma^2) \in \mathbb{R}^2 \> | \> -\infty < \mu < \infty, \sigma^2 > 0 \},
    \]
    \[
        {\color{red} \bracevert} \quad \Omega_0 = \{ (\mu, \sigma^2) \in \mathbb{R}^2 \> | \> \mu = \mu_0, \sigma^2 > 0 \},
    \]
    and the alternative parameter space is
    \begin{align*}
        \Omega_1 &= \{ (\mu, \sigma^2) \in \mathbb{R}^2 \> | \> \mu \neq \mu_0, \sigma^2 > 0 \}\\
        &= {\color{gray!45!white} \lgblksquare} \setminus {\color{red} \bracevert}
    \end{align*}
    ...
    \begin{figure}[ht]
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \node [above] at (current axis.above origin) {$\sigma$};
    ...
    \]
    Next we find the maximum of $L(\mu, \sigma^2)$ on the set $\Omega_0$. Since the set $\Omega_0$ is equal to 
...
\[
    {\color{orange!45!white} \lgblksquare} \quad \Theta = \{ (\mu, \sigma^2) \in \mathbb{R}^2 \> | \> -\infty < \mu < \infty, \sigma^2 > 0 \}
\]
\[
    {\color{red} \strns} \quad \Theta_0 = \{ (\mu, \sigma^2) \in \mathbb{R}^2 \> | \> -\infty < \mu < \infty, \sigma^2 = \sigma^2_0 \}
\]
and the alternative parameter space is
\begin{align*}
    \Theta_1 &= \{ (\mu, \sigma^2) \in \mathbb{R}^2 \> | \> -\infty < \mu < \infty, \sigma^2 \neq \sigma^2_0 \}\\
    &= {\color{orange!45!white} \lgblksquare} \setminus {\color{red} \strns}
\end{align*}
...
\begin{align*}
    ...
    &= -\frac{n}{2\varsigma} + \frac{1}{2(\varsigma)^2} \sum_{i=1}^{n} (x_i - \ols{x})^2 \label{eq:tst1.1} \tag{{\color{red} $\inversebullet$}}
\end{align*}
