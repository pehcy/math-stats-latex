...
mean value $\mu$.  What are some point estimators for $\mu$?
    ...
    \vspace{0.752cm}
    \begin{Exercise}
    Consider the following population of 5 measurements:
    \[
        15\quad 13\quad 8\quad 17\quad 9
    \]
    \begin{enumerate}
        \item Find the population mean and variance.
        \item The researcher picks a sample of size 3 from the population. The sample 
        consists of the measurements 15, 13, and 8. Calculate the sample mean and sampling error 
        for this sample.
        \item Referring to part (2), if the researcher mistakenly used the numbers $15, 13, 6$ to calculate
        the sample mean, find the sampling error and nonsampling error.
        \item List all the samples of 3 measurements (without replacements) that can be selected from the population. 
        Calculate the sample mean for each sample.
        \item For the sampling distribution of the mean, $\ols{X}$. Find $\mu_{\ols{X}}$ and $\sigma_{\ols{X}}$. 
        Are they equal to the calculation from the shortcut formula?
    \end{enumerate}
    \end{Exercise}
 ...
 method}.
    ...
    \begin{Exercise}
        What is the difference between the parameters and statistics?
    \end{Exercise}
    \begin{Answer}
        A parameter is a number that describes the population, while a statistic 
        is a number that describes the sample. 
    \end{Answer}
